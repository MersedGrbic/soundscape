...
const Sidebar = () => {
  return (
    <nav className="w-[100%] max-w-[250px] bg-main-bg rounded navbar">
      <ul>
        <li>
          <img src={logoImg} alt="soundscape logo image" />
        </li>
        <li>
          <NavLink
            to="/"
            className="flex gap-2 p-2 m-2 rounded hover:bg-secondary-bg cursor-pointer"
          >
            <svg
